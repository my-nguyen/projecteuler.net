...
public class euler_028
{
  ...
  static long formula(int size)
  {
    ...
    for (int i = 1; i <= (size-1)/2; i++)
    {
      ...
      long current = 4*(int)Math.pow((2*i+1),2) - 12*i + previous;
      previous = current;
    }
  ...
  public static void main(String[] args)
  {
    ...
    for (int size : sizes)
      System.out.println("Sum(" + size + "): " + spiral(size));
    for (int size : sizes)
